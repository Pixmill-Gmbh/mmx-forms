...
docker exec -ti $CONTAINER bash -c "composer config repositories.mmx-forms path /mmx-forms"
...
docker exec -ti $CONTAINER bash -c "composer require mmx/forms"
docker exec -ti $CONTAINER bash -c "composer exec mmx-forms install"
